		...
		if(entidadValidada.success){			
			if(entidadValidada.coincidencias.matches[name].length > 0){
				...
				if(coincidenciaExacta == true){
					...
					return res.status(400).send({ status: false, msg: "Se han encontrado coincidencias en la lista de sanciones de la OFAC", data: nuevoRegistro});
				}	
			}
			...
			if(entidadValidada.coincidencias.matches[name].length > 0){
				if(entidadValidada.coincidencias.matches[name].length > 0){
					...
					if(coincidenciaExacta == true){
						...
						return res.status(400).send({ status: false, msg: "Se han encontrado coincidencias en la lista de sanciones de la OFAC"});
					}	
				}
			}
